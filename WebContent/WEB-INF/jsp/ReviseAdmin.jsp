...
<body>
	<div class="container">
		...
		<div class="box">
				<div id="register_box">
					<h2>修改管理员信息页面</h2>
					<form action="${pageContext.request.contextPath}/admin/reviseAdmin.action" method="post" name="registerform" onsubmit="return checkregister()">
						...
						<div class="ui register">	
						姓&nbsp;&nbsp;&nbsp;&nbsp;名:&nbsp;<input id="name2" type="text" name="name" value="<c:out value="${vo.name}"/>"><br>
						</div>
						<div class="ui register">	
						...
						<input type="hidden" name="grade" value="<c:out value="${vo.grade}"/>">
						<input type="hidden" name="upper_id"value="<c:out value="${vo.upper_id}"/>">
						<div class="ui register">	
				...
				<br>
				<div><pre>唯e数码  客户服务系统 - 修改管理员信息页面！</pre></div> 
		</div>
	</div>
	<br><br>
	<p class="foot">
